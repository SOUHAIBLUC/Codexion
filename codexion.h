...
void						heap_insert(t_dongle *d, int coder_id,
								long deadline);
void						heap_remove(t_dongle *d);
int							heap_peek(t_dongle *d);
void						acquire_dongles_fifo(t_coder *coder,
								t_dongle *first, t_dongle *secnd,
								long cooldown);
void						acquire_dongles_edf(t_coder *coder, t_dongle *first,
								t_dongle *secnd, long cooldown);
void						release_dongles_fifo(t_coder *coder,
								t_dongle *first, t_dongle *secnd);
void						release_dongles_edf(t_dongle *first,
								t_dongle *secnd);
int							coder_work(t_coder *coder);
void						init_coder_order(t_coder *coder, t_dongle **first,
								t_dongle **secnd);
void						acquire_dongles(t_coder *coder, t_dongle *first,
								t_dongle *secnd, long cooldown);
void						release_dongles(t_coder *coder, t_dongle *first,
								t_dongle *secnd);
void						fifo_enqueue(t_coder *coder, t_dongle *first,
								t_dongle *secnd);
